        ...
        output+=`
          <div class="col-md-3">
            <div class="well text-center">
              ...
              <button onclick="function load(file){
                document.getElementById('details').innerHTML='<object type="text/html" data="details.html" ></object>'
              }; movieSelected('${movie.id}');" class="w3-button w3-black">Movie Details</button>
            </div>
          </div>
        `;
      });
